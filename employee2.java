...
class employee2 {
    public static void main(String... args) {
        ...
        System.out.printf("              EPF : %8.2f\n", epf);
        System.out.printf("DA        : %8.2f", da);
        System.out.printf("           IT  : %8.2f\n", it);
        System.out.printf("HRA       : %8.2f\n", hra);
        System.out.printf("OA        : %8d\n", oa);
        System.out.printf("CCA       : %8.2f\n", cca);
        System.out.printf("------------------------------------------------------------------\n");
        System.out.printf("GROSS SALARY : %8.2f", grossSal);
        System.out.printf("       GROSS DEDUCTION : %8.2f\n", grossDed);
        System.out.printf("------------------------------------------------------------------\n");
        System.out.printf("------------------------------------------------------------------\n");
